    ...
    static void reservarEntradas(Scanner scanner) {
        ...
        for (int i = 0; i < cantidad; i++) {
            ...
            if (asientoOcupado(asiento) || asientoFueraDeRango(asiento)) {
                ...
                entradas.add(new Entrada(asiento, "reservada", PRECIO_UNITARIO));
                totalReservas++;
                System.out.println("[DEBUG] La Reserva ha sido creada.");
            }
        }
    }
        ...
        if (resp == 's' || resp == 'S') {
            ...
            for (Entrada e : entradas) {
                if (e.getAsiento() == asiento && e.getEstado().equals("reservada")) {
                    ...
                    System.out.println("[DEBUG] La Reserva se ha convertido en compra :)");
                    return;
                }
            }
